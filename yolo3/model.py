...
def yolo_boxes_and_scores(feats,anchors,num_classes,input_shape,image_shape):
    ...
    print('yolo_head feats,anchors,num_classes,input_shape', yolo_head(feats,
...
def yolo_eval(yolo_outputs,anchors,num_classes,image_shape,max_boxes=20,score_threshold=.6,iou_threshold=.5):
    ...
    print('yolo_outputs[0] ',yolo_outputs[0])
    print('K.shape(yolo_outputs[0]) ',K.shape(yolo_outputs[0]))
    print("input_shape yolo_eval ",input_shape)
    boxes=[]
    box_scores=[]
    for l in range(3):
