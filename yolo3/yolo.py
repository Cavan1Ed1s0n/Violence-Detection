...
class YOLO(object):
    ...
    def generate(self):
        ...
        self.input_image_shape=tf.compat.v1.placeholder(tf.float32,shape=(2,))
        # self.input_image_shape= tf.keras.Input(shape=(2,))
        print('self.input_image_shape ',self.input_image_shape)
    ...
    def detect_image(self,image):
        ...
        print('tf.compat.v1.keras.backend.get_session ',tf.compat.v1.keras.backend.get_session())
